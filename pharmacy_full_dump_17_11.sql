...
--
-- Current Database: `Pharmacy`
--

/*!40000 DROP DATABASE IF EXISTS `Pharmacy`*/;
...
INSERT INTO `Cart` VALUES (3,'2025-11-14',6),(4,'2025-11-17',9);
...
INSERT INTO `Cash_on_Delivery` VALUES (1),(6),(8);
...
INSERT INTO `EWallet` VALUES (4,'0999999999','Momo'),(7,'0999999999','Momo');
...
INSERT INTO `Order` VALUES (1,'Completed','2025-11-17',9),(2,'Pending','2025-11-17',9),(3,'Pending','2025-11-17',9),(4,'Pending','2025-11-17',9),(5,'Completed','2025-11-17',9),(6,'Completed','2025-11-17',9),(7,'Pending','2025-11-17',9),(8,'Completed','2025-11-17',9),(9,'Pending','2025-11-17',9);
...
INSERT INTO `OrderDetail` VALUES (2,1),(3,1),(4,2),(5,2),(1,3),(2,3),(1,4),(2,4),(1,5),(1,6),(1,7),(1,8),(2,8),(1,9),(2,9);
...
INSERT INTO `Order_are_Detail` VALUES (1,3,3,1,20000.00),(1,4,3,1,20000.00),(1,5,3,5,100000.00),(1,6,4,1,30000.00),(1,7,3,1,20000.00),(1,8,3,1,20000.00),(1,9,7,4,60000.00),(2,1,5,2,246000.00),(2,3,5,1,123000.00),(2,4,6,1,50000.00),(2,8,6,1,50000.00),(2,9,5,5,615000.00),(3,1,3,25,500000.00),(4,2,3,6,120000.00),(5,2,4,1,30000.00);
...
INSERT INTO `Order_with_Shipment` VALUES (1,5),(2,6),(3,6),(4,7),(5,8),(6,9);
...
INSERT INTO `Organize_in_category` VALUES (3,1),(4,1),(7,1),(5,2),(6,2);
...
INSERT INTO `Payment` VALUES (1,'2025-11-17',746000.00,'Pending',NULL,1),(2,'2025-11-17',746000.00,'Completed',NULL,1),(3,'2025-11-17',100000.00,'Completed',NULL,5),(4,'2025-11-17',30000.00,'Completed',NULL,6),(5,'2025-11-17',30000.00,'Completed',NULL,6),(6,'2025-11-17',20000.00,'Pending',NULL,7),(7,'2025-11-17',70000.00,'Completed',NULL,8),(8,'2025-11-17',675000.00,'Pending',NULL,9);
...
INSERT INTO `Product` VALUES (3,20000.00,'Paracetamol',460,'A common pain reliever and fever reducer. Used to treat headaches, muscle aches, arthritis, backache, and fever caused by infections.'),(4,70000.00,'Amoxicillin',235,'A broad-spectrum antibiotic used to treat bacterial infections such as pneumonia, ear infections, urinary tract infections, and throat infections.'),(5,123000.00,'Ibuprofen',313,'A nonsteroidal anti-inflammatory drug (NSAID) that helps reduce fever, pain, and inflammation. Commonly used for menstrual cramps, headaches, and arthritis.'),(6,50000.00,'Loratadine',198,'An antihistamine used to relieve allergy symptoms such as runny nose, sneezing, and itchy or watery eyes. It does not usually cause drowsiness.'),(7,15000.00,'Thuốc xổ',396,'Đau bụng khi dùng');
...
INSERT INTO `Shipment` VALUES (1,'2025-11-17','Preparing'),(2,'2025-11-17','Preparing'),(3,'2025-11-17','Preparing'),(4,'2025-11-17','Preparing'),(5,'2025-11-17','Preparing'),(6,'2025-11-17','Preparing');
...
INSERT INTO `Shipment_Third_Party` VALUES (1,1,1),(2,1,1),(3,1,1),(4,1,1),(5,1,1),(6,1,1);
...
-- Dump completed on 2025-11-17 17:32:00
